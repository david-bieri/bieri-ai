...
Structure every migration as idempotent SQL so it can be re-run safely. See `references/migration.sql` for a complete multi-table example with RLS and seed data.
